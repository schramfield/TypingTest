// This is to work out what's happening with the circuit
//
...
#define lawng 500 // for long flashing
...
void setup() //////////////////////////////////////////
{
  ...
  digitalWrite(Lohm5, HIGH);
  digitalWrite(Lohm10, HIGH);
  digitalWrite(Lohm20, HIGH);
  digitalWrite(Lohm25, HIGH);

  digitalWrite(RNC, LOW);
  digitalWrite(RNO, HIGH);
  digitalWrite(Rohm5, HIGH);
  digitalWrite(Rohm10, HIGH);
  digitalWrite(Rohm20, HIGH);
  digitalWrite(Rohm25, HIGH);
