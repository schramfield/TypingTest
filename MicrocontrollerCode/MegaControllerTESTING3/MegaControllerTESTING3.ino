...
#define lawng 2000 // for long flashing
...
void setup() //////////////////////////////////////////
{
  ...
  digitalWrite(Lohm5, LOW);
  digitalWrite(Lohm10, LOW);
  digitalWrite(Lohm20, LOW);
  digitalWrite(Lohm25, LOW);

  digitalWrite(RNC, LOW);
  digitalWrite(RNO, HIGH);
  digitalWrite(Rohm5, LOW);
  digitalWrite(Rohm10, LOW);
  digitalWrite(Rohm20, LOW);
  digitalWrite(Rohm25, LOW);
